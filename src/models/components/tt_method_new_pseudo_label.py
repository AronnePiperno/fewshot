...
class T3ALNet(nn.Module):
    def __init__(
        ...
        self.avg_video_features = self.avg_support_features(self.support_features)
    ...
    def forward(self, x, optimizer):
        ...
        indexes, _ = self.infer_pseudo_labels_new(image_features, video_features)
        ...
        original_video_features = self.support_features[indexes.item()].unsqueeze(0).to(image_features.device)
