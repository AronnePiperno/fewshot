...
class T3ALNet(nn.Module):
    ...
    def forward(self, x, optimizer):
        ...
        # If no image projection, use the features directly
        ...
        for _ in range(self.steps):
            ...
            # Optionally remove background from features
        ...
        with torch.no_grad():
            ...
            similarity = self.model.logit_scale.exp() * (avg_feature_class @ image_features_norm.T)
