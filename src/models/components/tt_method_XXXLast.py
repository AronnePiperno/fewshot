...
class T3ALNet(nn.Module):
    ...
    def prototypical_loss(query_features, class_prototypes,class_label_idx, margin: float = 0.5, temperature: float = 0.1):
        """
        Forces adapted features to be closer to their class prototype 
        than to other prototypes by a margin.
        """
    ...
    def forward(self, x, optimizer):
        ...
        video_features =  video_features @ self.video_proj
        ...
        before_optimization_video_projection = copy.deepcopy(self.video_proj)
        ...
        for _ in range(self.steps):
            ...
            projected_video_features = original_video_features @ self.video_proj
