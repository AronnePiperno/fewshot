...
print(os.listdir(support_videos_path))

# take 1 random videos from each class (with a folder in support_videos) and copy them to the support_videos folder
for folder in os.listdir(support_videos_path):
    class_name = folder
    print('Processing', class_name)
    videos = ucf101_dict[class_name]
    random_videos = random.sample(videos, 3)
